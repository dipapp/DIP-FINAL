  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <BackButton />
          <h1 className="text-3xl font-bold text-gray-900 mt-4">Applicant Management</h1>
          <p className="text-gray-600 mt-2">Manage service provider applicants and track progress</p>
        </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {applicants.filter(a => a.status === 'completed').length}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white shadow rounded-lg overflow-hidden">
          {applicants.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">Create your first applicant to get started.</p>
            </div>
          ) : (
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {applicants.map((applicant) => (
                    <tr key={applicant.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900">{applicant.providerName}</div>
                      </td>
