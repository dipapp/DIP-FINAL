...
const features = [
  {
    ...
    description: 'Membership benefits that have you covered when accidents happen',
    color: '#10b981', // green
  ...
  },
  {
    icon: '💵',
    title: 'Just $20/month',
    description: 'Affordable monthly membership that saves you thousands',
    color: '#3b82f6', // blue
    bgColor: 'rgba(59, 130, 246, 0.1)',
  },
  {
    icon: '⚡',
    title: 'Instant Requests & Roadside Accident Towing',
    description: 'Submit requests in minutes with our streamlined process',
    ...
    <div className="min-h-0 bg-white text-gray-900 px-4 py-4">
      <div className="max-w-lg mx-auto space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          />
          <h2 className="text-lg font-light text-gray-900">Membership Benefits That Have You Covered</h2>
        </div>
