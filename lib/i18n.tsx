...
const translations = {
  en: {
    ...
    // Landing page
    'landing.tagline': 'Drive with confidence knowing you\'re protected',
    'landing.whyChoose': 'Why Choose DIP?',
    'landing.completeProtection': 'Complete Benefits',
    'landing.completeProtectionDesc': 'Your deductible is fully covered when accidents happen',
    'landing.monthlyPrice': 'Just $22.99/month',
    ...
    'landing.readyToGetProtected': 'Ready to get protected?',
  ...
  es: {
    ...
    // Landing page
    'landing.tagline': 'Conduce con confianza sabiendo que estás protegido',
    'landing.whyChoose': '¿Por qué elegir DIP?',
    'landing.completeProtection': 'Beneficios Completos',
    'landing.completeProtectionDesc': 'Tu deducible está completamente cubierto cuando ocurren accidentes',
    'landing.monthlyPrice': 'Solo $22.99/mes',
    ...
    'landing.readyToGetProtected': '¿Listo para estar protegido?',
