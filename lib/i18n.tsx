...
const translations = {
  en: {
    ...
    'landing.completeProtectionDesc': 'Your deductible is fully supported when accidents happen',
  ...
  es: {
    ...
    'landing.completeProtectionDesc': 'Tu deducible está completamente apoyado cuando ocurren accidentes',
