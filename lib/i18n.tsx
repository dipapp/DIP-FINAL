...
const translations = {
  en: {
    ...
    'landing.completeProtectionDesc': 'Your repair costs are fully supported when accidents happen',
  ...
  es: {
    ...
    'landing.completeProtectionDesc': 'Tus costos de reparación están completamente apoyados cuando ocurren accidentes',
