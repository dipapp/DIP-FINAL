...
const translations = {
  en: {
    ...
    'landing.completeProtectionDesc': 'Your personal expenses are fully supported when accidents happen',
  ...
  es: {
    ...
    'landing.completeProtectionDesc': 'Tus gastos personales están completamente apoyados cuando ocurren accidentes',
