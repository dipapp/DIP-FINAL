...
const translations = {
  en: {
    ...
    'landing.completeProtectionDesc': 'Your out-of-pocket expenses are fully supported when accidents happen',
  ...
  es: {
    ...
    'landing.completeProtectionDesc': 'Tus gastos de bolsillo están completamente apoyados cuando ocurren accidentes',
